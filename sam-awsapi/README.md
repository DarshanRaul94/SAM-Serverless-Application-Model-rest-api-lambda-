...
This is a sample template for sam-awsapi - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name sam-awsapi --tail
```
...
```bash
aws cloudformation delete-stack --stack-name sam-awsapi
```
